...
namespace Noise
{
	public delegate double Triple( double x, double y, double z );
    ...
    public static class Perlin
    {
        ...
        public static double RidgedMF(double x, double y, double z, int octaves, float lacunarity, float gain, float offset)
        {
            ...
            return sum;
				...
				public static double fBm( double x, double y, double z, Triple octaves, Triple lacunarity, Triple gain )
        {
            ...
            double sum = 0.0f;
						...
						double octaveVal = octaves( x, y, z );

						int octaveCount = (int)Math.Ceiling( octaveVal );

						double lacVal = lacunarity( x, y, z );
						double gainVal= gain( x, y, z );
